...
if __name__ == "__main__":
    config = "dbg" # "all" # "nio" # "reduced" # "balanced"
    cache_name = f"cwru12k_{config}.npy"
    dataset = CWRU12k(config=config, acquisition_maxsize=None)
